    	...
    	try {
    		if (message.toLowerCase().startsWith(getPrefix())) {
                ...
                if (split.length != 1) {
                	...
                	HttpResponse<String> response = Unirest.get("https://haveibeenpwned.com/api/v2/unifiedsearch/" + URLEncoder.encode(split[1], "UTF-8"))
                	.asString();
                	...
                	if(response.getStatus() == 200) {
                		...
                		breaches.forEach( breach -> {
                			...
                			meb.addField(jBreach.getString("Title"), (jBreach.getBoolean("IsVerified") ? "`Verified`" : "`Unverified`") + "\n", false);
                		});
                	} else {
