...
public class Google extends Command {
    ...
    private MessageEmbed getSearch(String q) {
        try {
            ...
            String url = "https://www.googleapis.com/customsearch/v1?" + "safe=medium&" + "q=" + URLEncoder.encode(q, "UTF-8") + "&cx=008677437472124065250%3Ajljeb59kuse&imgSize=small&lr=lang_en&num=5&key=" + Constants.GOOGLE_API_KEY;
